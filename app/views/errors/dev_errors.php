...
<div class="grid-12__container">
    <div class="page__section">
        <div class="error-panel">
            ...
            <ul class="error-info">
                <li class="error-info__item"><b class="error-info__highlight">Код ошибки:</b> <?=$errno?></li>
                <li class="error-info__item"><b class="error-info__highlight">Текст ошибки:</b> <?=$errstr?></li>
                <li class="error-info__item"><b class="error-info__highlight">Файл:</b> <?=$errfile?></li>
                <li class="error-info__item"><b class="error-info__highlight">Строка:</b> <?=$errline?></li>
            </ul>
        </div>
    </div>
</div>
